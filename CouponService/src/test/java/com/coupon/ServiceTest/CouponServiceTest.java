...
public class CouponServiceTest {
	...
	public void findByIdTest() throws CouponRequestException {
		when (couponRepository.findById("2")).thenReturn(Optional.of(new Coupon("2","user","food",20, "20%", "Bakery","url")));
		Optional<Coupon> cou = couponService.findByCouponId("2");
		assertEquals("2", cou.get().getCouponId());
		assertEquals("user",cou.get().getUserId());
	...
	public void findallTest() {
		Coupon c1=new Coupon("1","user","food",20, "20%", "Bakery","url");
		Coupon c2=new Coupon("2","user","food",20, "20%", "Bakery","url");
		Coupon c3=new Coupon("3","user","food",20, "20%", "Bakery","url");
		Coupon c4=new Coupon("4","user","food",20, "20%", "Bakery","url");
	...
	@Test 
	 public void deleteByIdTest() throws CouponRequestException {
		when (couponRepository.findById("6")).thenReturn(Optional.of(new Coupon("6","user","food",20, "20%", "Bakery","url")));
	...
	public void findByCategoryTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","user","food",20, "20%", "Bakery","url"));
		Optional<Coupon> c3=Optional.of(new Coupon("3","user","food",20, "20%", "Bakery","url"));
	...
	public void findByCompanyNameTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","user","food",20, "20%", "Bakery","url"));
		Optional<Coupon> c2=Optional.of(new Coupon("3","user","food",20, "20%", "Bakery","url"));
		List<Optional<Coupon>> coupon= new ArrayList<>();
		coupon.add(c1);
		coupon.add(c2);

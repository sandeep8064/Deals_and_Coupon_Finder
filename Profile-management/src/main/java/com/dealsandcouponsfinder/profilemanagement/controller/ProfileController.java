...
public class ProfileController {
 ...
 //creating method which returns list of all details of coupons
	 ...
	 /*-----------------------------------security----------------------------------*/
		...
		private ResponseEntity<?> subscribe(@RequestBody AuthenticationRequest request)
		{
			...
			try {
				...
				return ResponseEntity.ok(new AuthenticationResponse("Error while subscribing the user with username " + username));
